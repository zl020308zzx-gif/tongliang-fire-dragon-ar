...
export const PAGE2_CONFIG = {
  ...
  overviewSequence: {
    moduleIntervalMs: 2800,
    mainAnimationStartDelayMs: 700,
    modulePrepareLeadMs: 1000,
    finalPromptDelayMs: 1300,
  },
  ...
  performance: {
    maxPixelRatio: 1.75,
    maxTextureUploadsPerFrame: 1,
    fpsSampleDurationMs: 2000,
    liteFpsThreshold: 24,
    liteAnimationFrameMs: 40,
    slowTextureUploadMs: 24,
    criticalTextureTimeoutMs: 12000,
    modelIdleTimeoutMs: 2500,
  },
